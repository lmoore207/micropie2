...
public class HaemolyticExtractorTest {
	...
	public static void main(String[] args){
		...
		*/
		...
		String lineFile = "F:/MicroPIE/micropieInput/sentences/8.6 Haemolytic small.txt";
		//STEP 1: split sentences
		List<RawSentence> testSentences = sentBatPIEProcessor.createSentencesByLine(lineFile);
		...
		PhraseBasedExtractor extractor = new PhraseBasedExtractor(postagger, Label.c52, "Haemolytic Properties", null, null);
		extractor.setPhraseParser(phraseParser);
		extractor.readKeywords("F:\\MicroPIE\\micropieInput\\CharacterValueExtractors\\c52.Haemolytic&haemadsorption properties.key");
		
		for (RawSentence testSentence : testSentences) {
			Set prediction = new HashSet();
			prediction.add(Label.c52);
