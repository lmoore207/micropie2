...
public class PathogenicTargetOrganExtractorTest {
	...
	public static void main(String[] args){
		...
		*/
		...
		String lineFile = "F:/MicroPIE/micropieInput/sentences/8.5 Pathogen Target Organ.txt";
		//STEP 1: split sentences
		List<RawSentence> testSentences = sentBatPIEProcessor.createSentencesByLine(lineFile);
		...
		PhraseBasedExtractor extractor = new PhraseBasedExtractor(postagger, Label.c51, "Pathogen Target Organ", null, null);
		extractor.setPhraseParser(phraseParser);
		extractor.readKeywords("F:\\MicroPIE\\micropieInput\\CharacterValueExtractors\\c51.Pathogen target Organ.key");
