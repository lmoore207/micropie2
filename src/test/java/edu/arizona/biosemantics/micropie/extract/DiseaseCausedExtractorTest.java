...
public class DiseaseCausedExtractorTest {
	...
	public static void main(String[] args){
		...
		*/
		...
		AbstractSequenceClassifier nerClassifier= null;//jin
		...
		String lineFile = "F:/MicroPIE/micropieInput/sentences/8.4 Disease Caused.txt";
		//STEP 1: split sentences
		List<RawSentence> testSentences = sentBatPIEProcessor.createSentencesByLine(lineFile);
		...
		PhraseBasedExtractor extractor = new PhraseBasedExtractor(postagger, Label.c50, "Disease Caused", null, null);
		extractor.setPhraseParser(phraseParser);
		extractor.readKeywords("F:\\MicroPIE\\micropieInput\\CharacterValueExtractors\\c50.Disease caused.key");
		PostProcessor postProcessor = new PostProcessor();
		for (RawSentence testSentence : testSentences) {
			Set prediction = new HashSet();
			prediction.add(Label.c50);
